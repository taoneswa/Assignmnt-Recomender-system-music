...
# Displaying the names at the top of the UI
st.subheader('Authors:')
st.text('1. Priviledge Murombeka R207113W HDSC')
st.text('2. Peter Mutsiwa R195820R CTHSC')
st.text('3. Taoneswa Kasirai R204450W HAI')
st.text('4. Takunda Kondo R195926T CTHSC')
...
if st.button('Show Recommendation'):
    ...
    # Displaying recommended songs and their posters
    with col1:
